...
%typemap(in,numinputs=0,
  ...
  (PyObject* array = NULL)
{
  npy_intp dims[1] = { (npy_intp) $1_dim0 };
...
%typemap(argout,
  ...
  (DIM_TYPE* DIM1, DIM_TYPE* DIM2, DATA_TYPE** ARGOUTVIEWM_ARRAY2)
{
  npy_intp dims[2] = { (npy_intp) *$1, (npy_intp) *$2 };
  PyObject* obj = PyArray_SimpleNewFromData(2, dims, DATA_TYPECODE, (void*)(*$3));
  PyArrayObject* array = (PyArrayObject*) obj;
...
%typemap(argout,
  ...
  (DATA_TYPE** ARGOUTVIEWM_ARRAY3, DIM_TYPE* DIM1, DIM_TYPE* DIM2, DIM_TYPE* DIM3)
{
  npy_intp dims[3] = { (npy_intp)*$2, (npy_intp)*$3, (npy_intp)*$4 };
  PyObject* obj = PyArray_SimpleNewFromData(3, dims, DATA_TYPECODE, (void*)(*$1));
  PyArrayObject* array = (PyArrayObject*) obj;
...
%typemap(argout,
  ...
  (DIM_TYPE* DIM1, DIM_TYPE* DIM2, DIM_TYPE* DIM3, DATA_TYPE** ARGOUTVIEWM_ARRAY3)
{
  npy_intp dims[3] = { (npy_intp)*$1, (npy_intp)*$2, (npy_intp)*$3 };
  PyObject* obj= PyArray_SimpleNewFromData(3, dims, DATA_TYPECODE, (void*)(*$4));
  PyArrayObject* array = (PyArrayObject*) obj;
...
%{
#include "string.h"
#define _SPS_SWIG_64 strcmp(USER, "x86_64-unknown-linux-gnu")
#define _SPS_SWIG_32 strcmp(USER, "i686-unknown-linux-gnu")
%}

#if $_SPS_SWIG_64 == 0
%numpy_typemaps(size_t            , NPY_ULONGLONG   , int)
...
%numpy_typemaps(npy_clongdouble, NPY_CLONGDOUBLE, int)

%numpy_typemaps(npy_cfloat,  NPY_CFLOAT, size_t)
%numpy_typemaps(npy_cdouble, NPY_CDOUBLE, size_t)
%numpy_typemaps(npy_clongdouble, NPY_CLONGDOUBLE, size_t)
